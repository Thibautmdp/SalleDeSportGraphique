...
public class FConsulter_Liste_Clients extends javax.swing.JDialog {
     ...
     */
    public FConsulter_Liste_Clients(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FConsulter_Liste_Clients dialog = new FConsulter_Liste_Clients(new javax.swing.JFrame(), true);
